...
class color_image_based_door_frame_detection_state(BaseState):
    ...
    def do_action(self, ctx: FrameContext):
        ...
        roi_polygon_left_based_on_color_image, roi_polygon_right_based_on_color_image, mean_z_depth_to_frame_based_on_color_image, edges = color_image_based_frame_detection(ctx.depth_image_in_meters, ctx.color_image_color_based, ctx.depth_frame, DEPTH_RANGE = (1.7, 2.3))
