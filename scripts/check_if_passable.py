...
class BirdsEyePassabilityPipeline:
    ...
    def __init__(self, keyword, back_proj_params, filter_points_params, bev_params):
        self.keyword = keyword
        self.back_proj_params = back_proj_params
        self.filter_points_params = filter_points_params
